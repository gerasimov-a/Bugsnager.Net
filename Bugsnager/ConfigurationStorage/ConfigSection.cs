...
{
    class ConfigSection :  IConfigurationStorage
    {
        ...
        public static Dictionary<string,string> Settings
        {
            ...
            {
                object dict;
                Windows.Storage.ApplicationData.Current.LocalSettings.Values.TryGetValue("BugSnagOptions", out dict);
                ...
                else
                {
                    ...
                    Windows.Storage.ApplicationData.Current.LocalSettings.Values["BugSnagOptions"] = dictionary;
                    return dictionary;
                }
            }
        }
        ...
        {
            get { return _apiKey ?? "12345678901234567890123456789012"; }
